...
# 注意
1. 只有在`健全模式`设置为 __关__ 时此插件才会生效, 且只会在启动时检测游戏设置, 中途修改设置无效

2. 第一次使用时建议先在 DepInEx/config/DepInEx.cfg 中 Enable Logging.Console, 查看插件是否正常工作
<details>
